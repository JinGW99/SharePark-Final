        ...
        clients.forEach(s -> {
            ...
            if (roomNameHash.equals(s.getAttributes().get("roomNameHash"))){
                try {
                    ...
                    cDTO.setName("관리자");
                    cDTO.setMsg(userName + "님이" + roomName + "방에 입장하셨습니다.");
        ...
        clients.forEach(s -> {
            if (roomNamehash.equals(s.getAttributes().get("roomNameHash"))){
                ...
                try {
                    ChatDTO cDTO = new ChatDTO();
                    cDTO.setName("관리자");
                    cDTO.setMsg(userName + "님이" + roomName + "방에 입장하였습니다.");
                    cDTO.setDate(DateUtil.getDateTime("yyyy-MM-dd hh:mm:ss"));
