        ...
        <div class="align_rt">
            <div class="notice">
                ...
                <div class="tab">
                    <div class="tab_btn">
                        <ul>
                            <li><a href="#"><%=CmmUtil.nvl(SS_USER_ID)%>님의 예약 내역</a></li>
                        </ul>
                    </div>
                </div>
                <%
                ...
                <div class="tab_each">
                    <div class="reservation">
                        ...
                        <div class="descript">
                            ...
                            <a3>시작시간 : <%=CmmUtil.nvl(rDTO.getStart_time())%></a3>~<a3>끝 시간 : <%=CmmUtil.nvl(rDTO.getEnd_time())%></a3>
                            <div class="detail">
                                <button class="cancel" onclick="location.href='/deleteReser?sp_seq=<%=CmmUtil.nvl(rDTO.getSp_seq())%>';">예약 취소</button>
                            </div>
